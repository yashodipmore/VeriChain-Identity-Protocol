    ...
    return (
      <div className="pt-24 pb-12 px-4 max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 text-center">
          ...
          <p className="text-gray-500">Please connect your wallet to create an identity.</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="pt-24 pb-12 px-4 max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 text-center">
          ...
          <h2 className="text-xl font-display font-semibold text-gray-900 mb-2">Identity Already Exists</h2>
          <p className="text-gray-500">You have already created a VeriChain identity.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="pt-24 px-4 max-w-2xl mx-auto pb-16">
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-display font-bold text-gray-900 mb-2">Create Your Digital Identity</h2>
                ...
                <div key={label} className="flex items-center">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium
                    ${step > index + 1 ? 'bg-emerald-500 text-white' : 
                      step === index + 1 ? 'bg-violet-500 text-white animate-pulse' : 
                      'bg-gray-200 text-gray-500'}`}
                  >
                    {step > index + 1 ? '✓' : index + 1}
                  </div>
                  {index < 3 && (
                    <div className={`w-12 h-1 mx-1 ${step > index + 1 ? 'bg-emerald-500' : 'bg-gray-200'}`}></div>
                  )}
                </div>
              ))}
            </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                {...register('fullName')}
                type="text"
                className={`bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-violet-500 focus:border-violet-500 w-full px-4 py-3 ${errors.fullName ? 'border-red-500 focus:ring-red-500' : ''}`}
            ...
            <div>
              ...
              <input
                {...register('email')}
                type="email"
                className={`bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-violet-500 focus:border-violet-500 w-full px-4 py-3 ${errors.email ? 'border-red-500 focus:ring-red-500' : ''}`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                {...register('profession')}
                type="text"
                className={`bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-violet-500 focus:border-violet-500 w-full px-4 py-3 ${errors.profession ? 'border-red-500 focus:ring-red-500' : ''}`}
            ...
            <div>
              ...
              <input
                {...register('location')}
                type="text"
                className={`bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-violet-500 focus:border-violet-500 w-full px-4 py-3 ${errors.location ? 'border-red-500 focus:ring-red-500' : ''}`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                {...register('phone')}
                type="tel"
                className={`bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-violet-500 focus:border-violet-500 w-full px-4 py-3 ${errors.phone ? 'border-red-500 focus:ring-red-500' : ''}`}
          ...
          <div>
            ...
            <textarea
              {...register('bio')}
              className={`bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-violet-500 focus:border-violet-500 w-full px-4 py-3 min-h-[100px] resize-none ${errors.bio ? 'border-red-500 focus:ring-red-500' : ''}`}
          ...
          <div className="bg-violet-50 border border-violet-200 rounded-xl p-4 space-y-3">
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">AES-256 Encryption</p>
          ...
          <button
            ...
            className="bg-gradient-to-r from-violet-500 to-purple-600 text-white rounded-xl shadow-lg hover:from-violet-600 hover:to-purple-700 w-full flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed px-6 py-3 font-medium transition-all"
          >
            {isLoading ? (
              <>
