...
export function LandingPage({ onGetStarted }: LandingPageProps) {
  ...
  return (
    <div className="theme-orange">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div 
                key={index} 
                className="bg-orange-50/50 border border-orange-100 rounded-2xl p-8 hover:border-orange-300 hover:bg-orange-50 hover-lift transition-all duration-500"
              >
                <div className="w-16 h-16 bg-orange-100 border border-orange-200 rounded-xl flex items-center justify-center text-orange-600 mb-6">
                  {item.icon}
                </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              ...
              <div 
                key={index} 
                className="group bg-orange-50/50 border border-orange-100 rounded-2xl p-7 hover:border-orange-300 hover:bg-orange-50 hover-lift transition-all duration-500"
              >
                <div className="w-14 h-14 bg-orange-100 border border-orange-200 rounded-xl flex items-center justify-center text-orange-600 mb-5 group-hover:bg-orange-200 group-hover:border-orange-300 transition-all duration-500">
                  {feature.icon}
                </div>
      ...
      {/* Why QIE Section - Minimal & Professional */}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-3">
                Free Oracle Infrastructure
              </h2>
              <p className="text-gray-400">
                7 real-time price feeds at zero cost
              </p>
            </div>

            {/* Oracle Feeds - Simple Row */}
            <div className="flex flex-wrap justify-center gap-3 mb-12">
              {['BTC', 'ETH', 'QIE', 'BNB', 'XRP', 'USDT', 'USDC'].map((token, i) => (
                <div key={i} className="bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-white text-sm font-medium">
                  {token}
                </div>
              ))}
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
              <div className="grid grid-cols-3 text-center text-sm">
                {/* Header */}
                <div className="py-4 px-3 border-b border-white/10 text-gray-400">Operation</div>
                <div className="py-4 px-3 border-b border-white/10 text-gray-400">Chainlink</div>
                <div className="py-4 px-3 border-b border-white/10 text-orange-400 font-medium">QIE</div>
                
                {/* Rows */}
                <div className="py-4 px-3 border-b border-white/5 text-gray-300">1 Price Feed</div>
                <div className="py-4 px-3 border-b border-white/5 text-gray-500">$0.10 - $0.50</div>
                <div className="py-4 px-3 border-b border-white/5 text-green-400 font-bold">$0.00</div>
                
                <div className="py-4 px-3 border-b border-white/5 text-gray-300">7 Feeds</div>
                <div className="py-4 px-3 border-b border-white/5 text-gray-500">$0.70 - $3.50</div>
                <div className="py-4 px-3 border-b border-white/5 text-green-400 font-bold">$0.00</div>
                
                <div className="py-4 px-3 text-gray-300">1000 Calls</div>
                <div className="py-4 px-3 text-gray-500">$700 - $3,500</div>
                <div className="py-4 px-3 text-green-400 font-bold">$0.00</div>
              </div>
            </div>

            {/* Bottom Note */}
            <p className="text-center text-gray-500 text-sm mt-6">
              VeriChain saves <span className="text-green-400">$3,500+</span> per 1000 verifications
            </p>
          </div>
        </div>
      </section>

      {/* Architecture Section - Minimal & Professional */}
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-gray-500">
              Four-layer architecture for secure, private identity verification
            </p>
          </div>

          {/* Minimal Architecture - Horizontal Flow */}
          <div className="max-w-5xl mx-auto">
            {/* Desktop: Horizontal | Mobile: Vertical */}
            <div className="hidden md:flex items-center justify-between gap-4">
              {/* User */}
              <div className="flex-1 text-center">
                <div className="w-14 h-14 mx-auto mb-3 bg-gray-900 rounded-xl flex items-center justify-center">
                  <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                </div>
                <div className="text-sm font-semibold text-gray-900">User</div>
                <div className="text-xs text-gray-500 mt-1">React + ethers.js</div>
              </div>
              ...
              <div className="flex-1 text-center">
                ...
                <div className="text-sm font-semibold text-gray-900">Smart Contracts</div>
                <div className="text-xs text-gray-500 mt-1">7 Solidity Contracts</div>
              </div>
              ...
              {/* QIE Oracle */}
              <div className="flex-1 text-center">
                <div className="w-14 h-14 mx-auto mb-3 bg-orange-500 rounded-xl flex items-center justify-center">
                  <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                  </svg>
                </div>
                <div className="text-sm font-semibold text-gray-900">QIE Oracles</div>
                <div className="text-xs text-orange-600 font-medium mt-1">FREE • 7 Feeds</div>
              </div>
              ...
              <div className="flex-1 text-center">
                ...
                <div className="text-sm font-semibold text-gray-900">IPFS Storage</div>
                <div className="text-xs text-gray-500 mt-1">AES-256 Encrypted</div>
              </div>
            </div>
            ...
            <div className="md:hidden space-y-4">
              {[
                { icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', title: 'User Interface', desc: 'React + ethers.js', highlight: false },
                { icon: 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4', title: 'Smart Contracts', desc: '7 Solidity Contracts', highlight: false },
                { icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6', title: 'QIE Oracles', desc: 'FREE • 7 Feeds', highlight: true },
                { icon: 'M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4', title: 'IPFS Storage', desc: 'AES-256 Encrypted', highlight: false },
              ].map((item, i) => (
                <div key={i} className="flex items-center gap-4">
                  <div className={`w-12 h-12 flex-shrink-0 rounded-xl flex items-center justify-center ${item.highlight ? 'bg-orange-500' : 'bg-gray-900'}`}>
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <div className={`text-xs ${item.highlight ? 'text-orange-600 font-medium' : 'text-gray-500'}`}>{item.desc}</div>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-gray-100">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500 mt-1">ZK Circuits</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-orange-600">7</div>
                  <div className="text-xs text-gray-500 mt-1">Oracle Feeds</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-gray-900">65</div>
                  <div className="text-xs text-gray-500 mt-1">Tests Passing</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 max-w-5xl mx-auto">
            {[
              ...
              <div 
                key={index} 
                className="bg-orange-50/50 border border-orange-100 rounded-xl p-4 text-center hover:border-orange-300 hover:bg-orange-50 hover-lift transition-all duration-500"
              >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-5xl mx-auto">
            {[
              ...
              <div 
                key={index} 
                className="bg-orange-50/50 border border-orange-100 rounded-xl p-6 hover:border-orange-300 hover:bg-orange-50 hover-lift transition-all duration-500"
              >
                <div className="flex items-center justify-between mb-3">
            ...
            {[
              ...
              >
                <img 
                  src={member.photo} 
                  alt={member.name}
                  className="w-24 h-24 rounded-full object-cover mx-auto mb-6 shadow-lg border-4 border-white ring-2 ring-orange-200"
                />
