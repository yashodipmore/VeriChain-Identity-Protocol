    ...
    return (
      <div className="pt-24 px-4 max-w-4xl mx-auto">
        <div className="card text-center">
          ...
          <p className="text-slate-400">Please connect your wallet to generate ZK proofs.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="pt-24 px-4 max-w-4xl mx-auto pb-16">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold gradient-text mb-4">Zero-Knowledge Proofs</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              {errors.credentialType && (
                <p className="mt-2 text-xs text-red-400">{errors.credentialType.message}</p>
              )}
            </div>
            ...
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-2">
                Claim Statement <span className="text-red-400">*</span>
              </label>
              <input
                {...register('claim')}
                type="text"
                className={`input-field ${errors.claim ? 'border-red-500' : ''}`}
                placeholder="e.g., Bachelor's Degree in Computer Science"
                disabled={isGenerating}
              />
              {errors.claim && (
                <p className="mt-1 text-xs text-red-400">{errors.claim.message}</p>
              )}
            ...
            <div>
              ...
              <input
                {...register('secret')}
                type="password"
                className={`input-field ${errors.secret ? 'border-red-500' : ''}`}
                placeholder="Enter a secret passphrase"
                disabled={isGenerating}
              />
              {errors.secret && (
                <p className="mt-1 text-xs text-red-400">{errors.secret.message}</p>
              )}
              <p className="mt-1 text-xs text-slate-500">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-slate-400 text-sm">Credential Type</span>
                  <span className="font-mono text-sm">{generatedProof.credentialType}</span>
                </div>
                <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-slate-400 text-sm">Nullifier</span>
                  <span className="font-mono text-xs truncate max-w-[200px]">
              ...
              {verificationResult !== null && (
                <div className={`rounded-xl p-4 flex items-center gap-3 ${
                  verificationResult ? 'bg-emerald-500/20' : 'bg-red-500/20'
                }`}>
                  {verificationResult ? (
                    <>
                    ...
                    <>
                      ...
                      <span className="text-red-400 font-medium">Not Found On-Chain</span>
                    </>
                  )}
                </div>
              )}
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-slate-400">Raw Proof Data</span>
                  <button
                ...
                <pre className="bg-slate-900 rounded-xl p-4 text-xs font-mono overflow-x-auto max-h-48 overflow-y-auto">
      ...
      {/* How It Works */}
      <div className="mt-12">
        <h2 className="text-2xl font-bold text-center mb-8">How ZK Proofs Work</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="card text-center">
            <div className="w-12 h-12 rounded-full bg-indigo-500/20 flex items-center justify-center mx-auto mb-4">
              <span className="text-2xl">1️⃣</span>
            </div>
            <h3 className="font-semibold mb-2">Create Commitment</h3>
          ...
          <div className="card text-center">
            ...
            <h3 className="font-semibold mb-2">Generate Proof</h3>
            <p className="text-sm text-slate-400">
          ...
          <div className="card text-center">
            ...
            <h3 className="font-semibold mb-2">Verify On-Chain</h3>
            <p className="text-sm text-slate-400">
